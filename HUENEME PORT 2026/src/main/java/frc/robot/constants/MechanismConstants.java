...
public class MechanismConstants {
    public static class OperatorConstants {
        ...
        public static final TalonFXConfiguration lifterConfig = new TalonFXConfiguration().withCurrentLimits(
            ...
            new MotorOutputConfigs()
                ...
                .withNeutralMode(NeutralModeValue.Brake) // Neutral Mode = break
        ).withVoltage(
            new VoltageConfigs()
